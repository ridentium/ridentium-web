...
const CATEGORIE = ['tutte', 'magazzino', 'ordini', 'fornitori', 'ricorrenti', 'todo', 'crm', 'staff', 'sistema', 'altro'] as const
...
const CAT_COLOR: Record<string, string> = {
  ...
  fornitori:  'text-violet-400 bg-violet-400/10',
  ricorrenti: 'text-gold bg-gold/10',
  todo:       'text-purple-400 bg-purple-400/10',
  crm:        'text-pink-400 bg-pink-400/10',
  staff:      'text-red-400 bg-red-400/10',
  sistema:    'text-stone bg-stone/10',
